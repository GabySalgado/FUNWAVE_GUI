...
container_col2 = widgets.VBox(children=[MASK,MASK9,SourceX,SourceY,P,Q,Fx,Fy,Gx,Gy,AGE,WaveHeight])   
...
container_col3 = widgets.VBox([container_steadyTime,container_TIntvMean],
