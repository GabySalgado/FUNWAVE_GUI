...
from pyFiles2.PrincipalTab_1 import THL as Lt
from pyFiles2.PrincipalTab_2 import time_text, plotInt_text
from pyFiles2.PrincipalTab_3 import steady_time, T_INTV_MEAN
...
Surfmean_col1 = widgets.VBox([PLOT_label,space_box1,plot_results_button,space_box2,save_plot_results_button],
                                layout = widgets.Layout(width = '50%')) 
...
Surfmean_cols = widgets.HBox([Surfmean_col1]) #,Surfmean_col2])  # Surfmean columns container box
...
# create video tab
video_tabs = widgets.VBox([out_list_container,space_box2,surf_cols,Surfmean_cols,u_cols,umean_cols,v_cols,vmean_cols,
                          Hsig_cols,Hrms_cols,Havg_cols],
