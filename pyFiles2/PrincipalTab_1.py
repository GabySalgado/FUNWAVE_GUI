...
label_intro1 = widgets.HTML("""Upload your file in the Jupyter Notebook Home folder. Once the file is uploaded, identify 
its name (e.g. MyBathy.txt) and its total horizontal length (THL). Press "Generate Bathymetry File" to format the uploaded bathy file to the FUNWAVE format, and 
"Plot Bathymetry" to visualize the bathymetry.<br><br>
<b>NOTE: </b>This file must be a text of 1 row; with depth values [-] for underwater and [+] for surface.""",layout=widgets.Layout(width='90%'))
...
press the "Generate Bathymetry File"
button and proceed to Step #2.<br>The values are in <b>metric</b> units.""",
                           layout=widgets.Layout(width='90%'))

# domain discretization widgets

dom = widgets.BoundedFloatText(description='DX',min = '0.0',value='1',max='1',step='0.1',
...
press the "Create Bathymetry Input File"
button and proceed to Step #2.<br>The values are in <b>metric</b> units.""",
                           layout=widgets.Layout(width='90%'))
...
save_button = widgets.Button(description="Generate Bathymetry File",
