...
from pyFiles2.PrincipalTab_1 import page_BATHY,plot_button,save_button
...
from pyFiles2.PrincipalTab_2 import page_inputIntro     
...
from pyFiles2.PrincipalTab_2 import page_GenInput, inputFile_button
...
principal_tab.set_title(2,'Step 3: Run Funwave')    
principal_tab.set_title(3,'Step 4: Post Processing')
